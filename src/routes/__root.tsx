...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "BuildMatch | Delhi NCR's #1 Contractor Marketplace" },
      ...
      { name: "author", content: "BuildMatch" },
      { property: "og:title", content: "BuildMatch | Delhi NCR's #1 Contractor Marketplace" },
      ...
      { name: "twitter:site", content: "@BuildMatch" },
      { name: "twitter:title", content: "BuildMatch | Delhi NCR's #1 Contractor Marketplace" },
